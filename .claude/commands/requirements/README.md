...
Commands for Phase 3: Requirements refinement, mini-PRD creation, and BDD specification.
...
The Requirements phase is where:
...
- Requirements Process: `../../skills/af-requirements-process/SKILL.md`
...
- Requirements Guide: `../../docs/guides/requirements-guide.md`
