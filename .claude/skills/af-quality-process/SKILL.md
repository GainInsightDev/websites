---
name: af-quality-process
description: Use when validating documentation quality, running quality checks, or auditing documentation freshness. Covers validation scripts, git-aware incremental checks, stale doc detection, and repair workflows.
