...
description: |
  Use when working with AWS infrastructure, credentials, DNS/domains, Route53, CloudFront, S3 buckets,
  or Doppler secrets. Covers credential access patterns, domain setup, subdomain creation, and
  cross-account operations for GainInsight projects.
