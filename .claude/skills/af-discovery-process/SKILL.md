---
name: af-discovery-process
description: Use when exploring new product ideas, gathering project-level context, or creating initial project documentation and roadmaps. Covers 4-question interview framework, tech stack module selection, Linear feature creation, and problem exploration patterns.
...
1. **Identify document types:**
   - Ideation documents (from `af-ideation-expertise` skill or equivalent brainstorming)
...
2. Copy brand guidelines template: `cp .claude/templates/brand-guidelines-template.md docs/design/brand-guidelines.md`
3. Copy design decision log template: `cp .claude/templates/design-decision-log-template.md docs/design/design-decisions.md`

**Brand Guidelines (`docs/design/brand-guidelines.md`) contains:**
- Reference class declaration (what product is this "like"?)
- Visual identity (colors, typography, spacing tokens)
- Component preferences (which shadcn/ui components to use)
...
- **Always create** brand guidelines if project has UI
...
- ✅ UX foundation established: reference class declared, brand guidelines created, design decision log initialized
...
- Load `af-architecture-expertise` skill for ADR guidance

**For documentation standards:**
- Load `af-documentation-standards` skill
