...
description: Guide collaborative brainstorming and ideation sessions that produce structured documents for Discovery. Use when starting a new product/project idea, running a brainstorming session, or preparing ideation documents for import into AgentFlow Discovery.
