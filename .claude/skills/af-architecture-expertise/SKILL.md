---
name: af-architecture-expertise
description: |
  Use when making architectural decisions, creating ADRs, or reviewing code for architectural
  compliance. Covers ADR lifecycle, decision framework, common patterns for GainInsight Standard
  projects, and integration with AgentFlow phases.
...
- [Amplify Expertise](../af-amplify-expertise/SKILL.md) - Four-tier architecture patterns
- [GainInsight Standard](../af-gaininsight-standard/SKILL.md) - Infrastructure patterns
