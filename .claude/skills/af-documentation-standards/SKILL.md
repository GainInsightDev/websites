---
name: af-documentation-standards
description: Use when creating, validating, or updating documentation to ensure compliance with AgentFlow standards. Covers frontmatter requirements, bidirectional linking, TSDoc comments, README indexes, and Layer 3 documentation.
...
**For validation process**: See `.claude/skills/af-quality-process/SKILL.md`
