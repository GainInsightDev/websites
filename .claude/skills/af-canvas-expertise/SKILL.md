---
name: af-canvas-expertise
description: |
  Use when presenting content to the user visually via the Agentview canvas.
  Covers writing markdown, mermaid diagrams, HTML, and Excalidraw drawings to
  task-scoped canvases. Use this when the user asks to "show me" something,
  explain with a diagram, or display a file in the canvas.
