...
Team
  └── Milestone (delivery goal — serves as "Epic")
        └── Issue (one unit of deliverable capability)
              ├── [Behaviour] Sub-issue (scenarios — created in Refinement)
              ├── [UX] Sub-issue (Storybook/RTL — created in Refinement)
...
| **Refinement** | Take ONE Feature, create Mini-PRD with Scenarios, create [Behaviour] and [UX] sub-issues | Mini-PRD, selector contract, Storybook, RTL tests |
...
Why? Refinement benefit from holistic thinking:
...
Milestone (delivery goal)
  └── Feature / Issue (one unit of deliverable capability)
        ├── [Behaviour] Sub-issue (scenarios — Refinement phase)
        ├── [UX] Sub-issue (Storybook/RTL — Refinement phase)
...
- [Discovery Process](../../skills/af-discover-scope/SKILL.md) - Creating Milestones and Features
- [Refinement Process](../../skills/af-refine-specifications/SKILL.md) - Feature → Mini-PRD → Scenarios
- [Behaviour/BDD Expertise](../../skills/af-write-bdd-scenarios/SKILL.md) - Writing Behaviour scenarios
- [Testing Guide](./testing-guide.md) - Test writing timeline and patterns
- [Work Management](../../skills/af-manage-work-state/SKILL.md) - Linear issue hierarchy
